...
From just the top 20 words, and the wordcloud we can start to make some general characterizations about sightings:
...
Again, we notice intersting things right away:
  ...
  * Surprisingly, no one seems to relate Bigfoot to Chewbaca, but instead, to the more realistic HARRY and the HENDERSONs [#9].
  * The survivors also seem to have sort sort of obsesive compulsive disorder, repeating words (NICHE NICHE [#1], l l [#3], HOLLOW HOLLOW [#18]).
